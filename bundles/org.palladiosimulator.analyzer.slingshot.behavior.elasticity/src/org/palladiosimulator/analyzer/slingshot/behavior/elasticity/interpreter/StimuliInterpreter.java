...
import org.palladiosimulator.analyzer.slingshot.behavior.elasticity.interpreter.ScalingTriggerInterpreter.InterpretationResult;
import org.palladiosimulator.analyzer.slingshot.behavior.elasticity.interpreter.entity.trigger.CPUUtilizationTriggerChecker;
import org.palladiosimulator.analyzer.slingshot.behavior.elasticity.interpreter.entity.trigger.OperationResponseTimeTriggerChecker;
import org.palladiosimulator.analyzer.slingshot.behavior.elasticity.interpreter.entity.trigger.QueueLengthTriggerChecker;
import org.palladiosimulator.analyzer.slingshot.behavior.elasticity.interpreter.entity.trigger.SimulationTimeChecker;
...
import org.palladiosimulator.elasticity.triggers.expectations.ExpectedTime;
...
import org.palladiosimulator.elasticity.triggers.stimuli.SimulationTime;
import org.palladiosimulator.elasticity.triggers.stimuli.TaskCount;
import org.palladiosimulator.elasticity.triggers.stimuli.util.StimuliSwitch;
...
final class StimuliInterpreter extends StimuliSwitch<InterpretationResult> {
    ...
    public StimuliInterpreter(final ScalingTriggerInterpreter scalingTriggerInterpreter,
