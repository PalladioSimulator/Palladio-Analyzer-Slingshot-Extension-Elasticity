...
public interface ValueComparator {
    ...
    /**
     * Compares the first and second value to some comparison semantic. For example, in the case of
     * {@link SimpleFireOnValue} with the relational operator GREATER_THAN_VALUE, the result will be
     * {@link ComparatorResult#IN_ACCORDANCE} if firstValue > secondValue, otherwise it will be
     * {@link ComparatorResult#DISREGARD}. <br>
     * If the trigger is a {@link SimpleFireOnTrend}, then the result could also be
     * {@link ComparatorResult#WAIT} if the threshold for the aggregation has not been reached yet.
     */
    ...
    static ValueComparator fromTrigger(BaseTrigger trigger) {
        ...
        throw new IllegalArgumentException(
                "Only SimpleFireOnValue and SimpleFireOnTrend are supported," + " but trigger is " + trigger.getClass()
                    .getSimpleName());
    }
