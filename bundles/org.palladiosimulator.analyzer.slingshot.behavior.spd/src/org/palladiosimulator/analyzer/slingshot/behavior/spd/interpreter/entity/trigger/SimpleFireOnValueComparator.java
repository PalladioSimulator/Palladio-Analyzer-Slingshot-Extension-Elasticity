...
import org.palladiosimulator.elasticity.triggers.RelationalOperator;
...
public class SimpleFireOnValueComparator implements ValueComparator {
    ...
    private double getValue(final ExpectedValue primitive) {
        ...
        throw new IllegalStateException("The proivded ExpectedPrimitive is not defined: " + primitive.getClass()
            .getSimpleName());
    }
}
