...
/**
 * This class holds the state for each scaling policy definition. The state include information
 * about when the latest adjustment has happened, as well as how many scaling has happened.
 *
