 ...
 */
/**
 * An event that is scheduled at an exact simulation time. In context of the Slingshot Elasticity
 * Extension, this is needed especially for triggers with simulation time stimulus.
 * 
 ...
 */
public class SimulationTimeReached extends AbstractSimulationEvent implements ElasticityBasedEvent {

    private final String targetGroupId;

    /**
     * Constructs a new simulation time reached event that is scheduled at exactly
     * {@code simulationTime} and a possibly a {@code delay}.
     * 
     * The constructed event should then be scheduled AFTER the current simulation time. If the
     * specified simulation time is in the past, an exception at the event bus might occur.
     * 
     * @param targetGroupId
     *            The target group identifier this event belongs to.
     * @param simulationTime
     *            A positive number that specifies the exact simulation time that should be reached.
     * @param delay
